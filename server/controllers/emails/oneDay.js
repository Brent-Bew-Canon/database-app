function oneDay(name, date, tier) {
    if (tier === "Gold") {
        return `<!DOCTYPE html>
                                          ...
                                          <tbody>
                                              <tr>
                                                  <td class="column column-1"
                                                              ...
                                                              <td class="pad">
                                                                  <div
                                                                      ...
                                                                      <p style="margin: 0; margin-bottom: 16px;">Hi ${name}!
                                                                          ...
                                                                          us tomorrow <strong>${date}</strong>. </p>
                                                      ...
                                                      <!--[if mso]><style>#list-r0c0m3 ul{ margin: 0 !important; padding: 0 !important; } #list-r0c0m3 ul li{ mso-special-format: bullet; }#list-r0c0m3 .levelOne li { margin-top: 0 !important; } #list-r0c0m3 .levelOne { margin-left: -20px !important; }#list-r0c0m3 .levelTwo li { margin-top: 0 !important; } #list-r0c0m3 .levelTwo { margin-left: 10px !important; }#list-r0c0m3 .levelThree li { margin-top: 0 !important; } #list-r0c0m3 .levelThree { margin-left: 40px !important; }#list-r0c0m3 .levelFour li { margin-top: 0 !important; } #list-r0c0m3 .levelFour { margin-left: 70px !important; }#list-r0c0m3 .levelFive li { margin-top: 0 !important; } #list-r0c0m3 .levelFive { margin-left: 100px !important; }</style><![endif]-->
                                                      <table border="0" cellpadding="10" cellspacing="0"
                                                          class="list_block block-4" id="list-r0c0m3" role="presentation"
                                                          style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                                          width="100%">
                                                          <tr>
                                                              <td class="pad">
                                                                  <div class="levelOne" style="margin-left: 0;">
                                                                      <ul class="leftList" start="1"
                                                                          style="margin-top: 0; margin-bottom: 0; padding: 0; padding-left: 20px; font-weight: 400; text-align: left; color: #101112; direction: ltr; font-family: Arial,Helvetica,sans-serif; font-size: 16px; letter-spacing: 0; line-height: 120%; mso-line-height-alt: 19.2px; list-style-type: disc;">
                                                                          <li style="margin-bottom: 0; text-align: left;">
                                                                              All electrical connections</li>
                                                                          <li style="margin-bottom: 0; text-align: left;">
                                                                              Fan motors</li>
                                                                          <li style="margin-bottom: 0; text-align: left;">
                                                                              Blower motors</li>
                                                              ...
                                                              <td class="pad">
                                                                  <div
                                                                      ...
                                                                      <p style="margin: 0; margin-bottom: 16px;">Please
                                                                          contact us immediately if you need to make any
                                                          ...
                                                          <tr>
                                                              <td class="pad">
                                                                  <div
                                                                      ...
                                                                      This is your reminder of your appointment with
                                                                      us tomorrow <strong>${date}</strong>. </p>
                                                                      <p style="margin: 0;">As a Silver member, we will be
                                                                          checking up on the following for your AC
                                                                          systems:</p>
                                                                  </div>
                                                              </td>
